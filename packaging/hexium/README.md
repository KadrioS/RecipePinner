...
| **Needs** | [BepInExPack Valheim](https://valheim.hexium.gg/mods/denikson/BepInExPack_Valheim) 5.4.2350 or newer, and nothing else. |
...
| **Optional** | [Configuration Manager](https://valheim.hexium.gg/mods/Azumatt/Official_BepInEx_ConfigurationManager), to change any of the sixty settings in-game. |
...
Install [Official BepInEx ConfigurationManager](https://valheim.hexium.gg/mods/Azumatt/Official_BepInEx_ConfigurationManager) and press `F1` in-game. Editing `BepInEx/config/com.Kadrio.RecipePinner.cfg` by hand works too; deleting that file restores every default on the next launch.
...
Install with [Thunderstore Mod Manager](https://www.overwolf.com/app/thunderstore-thunderstore_mod_manager), [r2modman](https://thunderstore.io/c/valheim/p/ebkr/r2modman/) or Recommended [Gale](https://hexium.gg/mod-manager).
